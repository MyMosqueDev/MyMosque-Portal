...
export default function ImageUploader({ previewUrl, onFileSelect, onClear, label = "Add image" }: ImageUploaderProps) {
  ...
  return (
    <div className="relative w-40 shrink-0">
      <label
        ...
        style={previewUrl ? { borderColor: "transparent" } : { borderColor: "var(--neutral-border)" }}
      >
        {previewUrl ? (
