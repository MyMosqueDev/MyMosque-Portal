...
import { Clock, Bell, Calendar, Users, Smartphone, Globe, Star, Heart, Moon, Menu } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 relative overflow-hidden">
          ...
          <div className="md:hidden border-t border-white/20 bg-white/90 backdrop-blur-xl">
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <Link href="/auth/join" className="block">
                <Button className="w-full bg-gradient-to-r from-mosque-green to-mosque-blue hover:from-mosque-green-light hover:to-mosque-blue-light rounded-lg shadow-lg">
                  Join
                </Button>
              </Link>
            </div>
      ...
      <section className="relative py-12 md:py-24 px-4">
        <div className="container mx-auto text-center relative z-10">
          <Badge className="mb-6 md:mb-8 bg-mosque-green/20 text-mosque-green border-mosque-green/20 rounded-full px-4 md:px-6 py-2 shadow-lg backdrop-blur-sm text-sm md:text-base">
            Connecting Communities
          </Badge>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 leading-tight px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 px-4">
            <Link href="/auth/join">
              <Button
                size="lg"
                className="bg-gradient-to-r from-mosque-green to-mosque-blue hover:from-mosque-green-light hover:to-mosque-blue-light rounded-full px-6 md:px-8 py-3 md:py-4 text-base md:text-lg shadow-2xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto"
              >
                Start Your Journey
              </Button>
            </Link>
            <Link href="#features">
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-6 md:px-8 py-3 md:py-4 text-base md:text-lg border-2 border-mosque-blue/30 hover:bg-mosque-blue/5 backdrop-blur-sm bg-transparent w-full sm:w-auto"
              >
                Discover More
              </Button>
            </Link>
      ...
      {/* Floating Hero Cards */}
      <section className="px-4 mb-16 md:mb-24 relative">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative">
            {/* Main Hero Image */}
            <div className="md:col-span-2 relative">
              <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-all duration-500">
                <Image
                ...
                <div className="absolute bottom-4 md:bottom-8 left-4 md:left-8 text-white">
                  <h3 className="text-xl md:text-3xl font-bold mb-2 md:mb-3">Empowering Sacred Connections</h3>
                  <p className="text-base md:text-lg opacity-90">Where tradition meets innovation</p>
                </div>
              </div>
            </div>

            <div className="space-y-4 md:space-y-6">
              <Card className="bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm border-0 shadow-xl rounded-2xl md:rounded-3xl transform hover:scale-105 transition-all duration-300">
              ...
              <Card className="bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm border-0 shadow-xl rounded-2xl md:rounded-3xl transform hover:scale-105 transition-all duration-300">
                <CardContent className="p-4 md:p-6 text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-mosque-blue to-mosque-purple rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 shadow-lg">
                    <Bell className="h-6 w-6 md:h-8 md:w-8 text-white" />
                  </div>
                  <h4 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">100+</h4>
                  <p className="text-sm md:text-base text-gray-600">Daily Notifications</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section id="features" className="py-16 md:py-24 px-4 relative">
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16 md:mb-20">
            <Badge className="mb-4 md:mb-6 bg-mosque-purple/20 text-mosque-purple border-mosque-purple/20 rounded-full px-4 md:px-6 py-2 text-sm md:text-base">
              Magical Features
            </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="group bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-sm border-0 shadow-xl rounded-2xl md:rounded-3xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 overflow-hidden"
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                ></div>
                <CardHeader className="relative z-10 p-4 md:p-6">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-mosque-green/20 to-mosque-blue/20 rounded-2xl flex items-center justify-center text-mosque-blue mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                    {feature.icon}
                  </div>
                  <CardTitle className="text-lg md:text-xl font-bold text-gray-900 group-hover:text-mosque-blue transition-colors duration-300">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="relative z-10 p-4 md:p-6 pt-0">
                  <CardDescription className="text-sm md:text-base text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                    {feature.description}
                  </CardDescription>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
            <div className="text-center group">
              <div className="relative mb-6 md:mb-8">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-mosque-green to-mosque-blue rounded-full flex items-center justify-center text-white text-2xl md:text-3xl font-bold mx-auto shadow-2xl group-hover:scale-110 transition-transform duration-300">
                  1
                </div>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-gray-900">Sign Up Your Mosque</h3>
            ...
            <div className="text-center group">
              <div className="relative mb-6 md:mb-8">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-mosque-blue to-mosque-purple rounded-full flex items-center justify-center text-white text-2xl md:text-3xl font-bold mx-auto shadow-2xl group-hover:scale-110 transition-transform duration-300">
                  2
                </div>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-gray-900">Create & Share</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed px-4">
            ...
            <div className="text-center group">
              <div className="relative mb-6 md:mb-8">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-mosque-purple to-mosque-green rounded-full flex items-center justify-center text-white text-2xl md:text-3xl font-bold mx-auto shadow-2xl group-hover:scale-110 transition-transform duration-300">
                  3
                </div>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-gray-900">Connect Hearts</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed px-4">
      ...
      <section className="py-16 md:py-24 px-4 relative">
        <div className="container mx-auto text-center relative z-10">
          <div className="bg-gradient-to-br from-mosque-green via-mosque-blue to-mosque-purple rounded-2xl md:rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
              ...
              <Link href="/auth/join">
                <Button
                  size="lg"
                  className="bg-white text-mosque-green hover:bg-gray-50 rounded-full px-8 md:px-10 py-3 md:py-4 text-base md:text-lg font-semibold shadow-xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                >
